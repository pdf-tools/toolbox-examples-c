...
Use CMake to produce a makefile that compiles the sample `toolboxmergeandcreatetableofcontents`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./toolboxmergeandcreatetableofcontents <inputPath> [<inputPath2> ...] <outputPath>`
