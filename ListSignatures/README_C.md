...
This kit contains the ListSignatures sample for PdfTools SDK for C. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
Use CMake to produce a makefile that compiles the sample `toolboxlistsignatures`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./toolboxlistsignatures <inputPath>`
