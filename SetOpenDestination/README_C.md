...
Use CMake to produce a makefile that compiles the sample `toolboxsetopendestination`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./toolboxsetopendestination <inputPath> <pageNumber> <outputPath>`
