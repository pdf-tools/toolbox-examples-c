...
int Usage()
{
    printf("Usage: toolboxadddatamatrix <inputPath> <imagePath> <outputPath>.\n");
    printf("       Example: in.pdf in.png out.pdf\n");
