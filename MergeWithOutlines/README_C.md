...
Use CMake to produce a makefile that compiles the sample `toolboxmergewithoutlines`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./toolboxmergewithoutlines <inputPath> [<inputPath2> ...] <outputPath>`
