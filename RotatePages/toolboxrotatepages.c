...
int Usage()
{
    printf("Usage: toolboxrotatepages <pageNumber> [<pageNumber2> ...] <inputPath> <outputPath>.\n");
    printf("       Example: 2 4  in.pdf out.pdf\n");
...
int _tmain(int argc, TCHAR* argv[])
{
    ...
    aPageNumbers = (int*)malloc(nPages * sizeof(int*));
    for (int i = 0; i < nPages; i++)
    {
        aPageNumbers[i] = (int)atoi(argv[i + 1]);
    }

    szInPath  = argv[argc - 2];
