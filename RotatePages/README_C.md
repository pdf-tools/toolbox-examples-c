...
Use CMake to produce a makefile that compiles the sample `toolboxrotatepages`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./toolboxrotatepages <pageNumber> [<pageNumber2> ...] <inputPath> <outputPath>`
